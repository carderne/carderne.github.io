...
- there are a bunch of motion plugins like [vim-easymotion](https://github.com/easymotion/vim-easymotion) and [vim-sneak](https://github.com/justinmk/vim-sneak) that I haven't yet tried but am keen to!
